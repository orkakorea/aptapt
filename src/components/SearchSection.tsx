  ...
  return (
    <section className="relative z-[2]">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="relative">
        ...
        <button
          type="submit"
          className="w-[71px] h-[71px] absolute z-[2] flex items-center justify-center cursor-pointer bg-[#6C2DFF] rounded-[10px] left-[1218px] top-[357px] max-md:w-[60px] max-md:h-[60px] max-md:left-[calc(85%_-_5px)] max-md:top-[280px] max-sm:w-[50px] max-sm:h-[50px] max-sm:left-[calc(92.5%_-_5px)] max-sm:top-[220px] hover:bg-[#5a24d9] transition-colors"
          aria-label="검색"
        >
          <svg
            width="25"
      ...
      {errors.searchQuery && (
        <div className="absolute left-[637px] top-[440px] text-red-500 text-sm max-md:left-[15%] max-md:top-[350px] max-sm:left-[7.5%] max-sm:top-[280px]">
