        ...
        <div className="h-full px-6 py-4">
          <div className="pointer-events-auto space-y-4">
            ...
            <div className="relative">
              <input className="w-full h-12 rounded-[10px] border border-neutral-300 bg-white pl-4 pr-12 text-sm placeholder:text-neutral-500 outline-none" placeholder="지역명, 아파트 이름, 단지명, 건물명을 입력해주세요" />
              <button type="button" className="absolute right-2 top-1/2 -translate-y-1/2 inline-flex h-8 w-8 items-center justify-center rounded-md bg-[#6C2DFF]" aria-label="검색">
                {/* 돋보기 아이콘 */}
            ...
            <div className="space-y-2">
              ...
              <button type="button" className="w-full h-12 rounded-[10px] border border-neutral-300 bg-white flex items-center justify-between px-3 text-sm text-gray-600">
                <span>날짜를 선택하세요</span>
                {/* 캘린더 아이콘 */}
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            ...
            {/* 빈 장바구니 카드 */}
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 py-[200px]">
              <div className="h-40 rounded-xl border border-neutral-200 bg-neutral-50 flex flex-col items-center justify-center text-gray-600">
                {/* 빌딩 아이콘 */}
                <svg width="92" height="102" viewBox="0 0 92 102" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-0 px-[10px]">
