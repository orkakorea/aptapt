            ...
            <div className="grid grid-cols-12 gap-6 p-6">
                      ...
                      {(forceSeatOpen || seatOpen) && (
                        ...
                        >
                          ...
                          <div className="px-5 pb-4">
                            <QuoteMiniTable items={quoteItems} showVatBreakdown vatRate={0.1} />
                          </div>
                        </motion.div>
                      )}
                    </AnimatePresence>
              ...
              <div className="col-span-12 lg:col-span-4 space-y-6">
                ...
                <Box>
                  ...
                  <div className="px-5 py-4 space-y-2 text_sm">
                    <a
...
function Step({ icon, title, children }: React.PropsWithChildren<{ icon: string; title: string }>) {
  return (
    <div className="flex items-start gap-3">
      <div className="h-6 w-6 rounded-full border border-[#E5E7EB] flex items-center justify_center text-xs text-[#6B7280]">
        {icon}
      </div>
