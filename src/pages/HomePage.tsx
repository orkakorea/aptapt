    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="bg-[#F4ECFF]">
        <div className="w-full max-w-[960px] mx-auto px-6 pt-[120px] pb-20 text-center">
          ...
          {/* Search Bar */}
          <div className="w-full max-w-[560px] h-12 mx-auto relative overflow-hidden bg-white border border-[#E5E7EB] rounded-full focus-within:ring-2 focus-within:ring-[#C7B8FF]">
            <input
              value={q}
