...
const ContractNewPage: React.FC = () => {
  ...
  .field-end1 { left: 31.2380%; top: 41.6154%; width: 9.0085%; height: 1.1538%; }
  .field-end2 { left: 31.2380%; top: 45.3077%; width: 9.0085%; height: 1.1538%; }
  .field-end3 { left: 31.2380%; top: 49.0769%; width: 9.0085%; height: 1.1538%; }
  .field-end4 { left: 31.2380%; top: 52.8077%; width: 9.0085%; height: 1.1538%; }
  .field-end5 { left: 31.2380%; top: 56.4231%; width: 9.0085%; height: 1.1538%; }
  .field-end6 { left: 31.2380%; top: 60.1923%; width: 9.0085%; height: 1.1538%; }
